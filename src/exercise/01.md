...
``
The DOM is a programin interface fot html and xml documents it represents the page so that programs can change the document stucture and content. the dom represents the documents as nodes and objets 
``
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=paulapierina96%40gmail.com).
