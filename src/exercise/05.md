...
extra credit of the previous exercise and add type annotations to it. We're
moving from the `*.html` files to `*.tsx` files. This is more real-world and
also your editor likely supports TypeScript better within TypeScript files
...
[Production deploy](http://react-fundamentals.netlify.app/isolated/final/05.extra-2.tsx)
...
[Production deploy](http://react-fundamentals.netlify.app/isolated/final/05.extra-3.tsx)
...
[Production deploy](http://react-fundamentals.netlify.app/isolated/final/05.extra-4.tsx)
...
having a runtime error, so it's less of a problem.
